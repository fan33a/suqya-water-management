...
<body>
    ...
    <header>
      <div class="container">
        ...
        <nav>
          <ul>
            <li><a href="#" onclick="return false;">عن الشركة</a></li>
            <li><a href="#" onclick="return false;">الخدمات</a></li>
            <li><a href="#" onclick="return false;">اتصل بنا</a></li>
            <li><a href="#" onclick="return false;">من نحن</a></li>
          </ul>
        </nav>
        <div class="btn-group">
