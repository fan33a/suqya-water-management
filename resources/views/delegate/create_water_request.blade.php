    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu flex flex-column">
            ...
            <li class="active flex">
                <img src="{{ asset('images/dashbordIcons/tint.png') }}" alt="water" />
                ...
                <div class="form-section">
                    ...
                    <div class="capacity-fields">
                        <div class="input-group">
                            ...
                            <div class="error-message">@error('latitude'){{ $message }}@enderror</div>
                        </div>
                        <div class="input-group">
                            ...
                            <div class="error-message">@error('longitude'){{ $message }}@enderror</div>
                        </div>
                    </div>
                </div>
